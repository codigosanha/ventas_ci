                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/store" method="POST">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precio_compra')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="precio_compra" name="precio_compra" value="<?php echo set_value('precio_compra');?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precio_venta_unitario')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="precio_venta_unitario" name="precio_venta_unitario" value="<?php echo set_value('precio_venta_unitario');?>">
                            ...
                            <div class="form-group <?php echo !empty(form_error('precio_venta_mayoreo')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="precio_venta_mayoreo" name="precio_venta_mayoreo" value="<?php echo set_value('precio_venta_mayoreo');?>">
